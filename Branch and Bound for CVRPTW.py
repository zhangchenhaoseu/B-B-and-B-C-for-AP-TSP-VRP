...
# branch and bound for Capacity Vehicle Routing Problem with Time Window
...
def plotSolution(global_LB_lst, global_UB_lst,customerNum):
    ...
    plt.title(f"Iteration of the B&B for CVRPTW({customerNum}customers)")
